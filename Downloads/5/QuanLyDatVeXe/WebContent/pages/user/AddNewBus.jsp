...
<link rel="stylesheet" href="${pageContext.request.contextPath}/public/css/style-customize.css" />
    ...
    <div class="container body">
      <div class="main_container">
		...
		<div class="row">
			...
			<div class="col-md-7">
		<html:form styleClass="form-horizontal" action="user/addNewBus">
			<div class="form-group">
				<label class="control-label col-sm-2" for="email">Tên Xe <span style="display:inline; color:red" >(*)</span>:</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="tenXe" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="pwd">Biển Số <span style="display:inline; color:red" >(*)</span>:</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<select name="maLoaiXe" class=" form-control select-tag" >
