						...
						<div class="container">
							<div class="col-md-12 ">
								<table id="table">
									...
									<logic:iterate name="listUserForm"
										property="listUser" id="user">
										<tr>
											...
											<bean:define id="MaNguoiDung" name="user"
												property="maNguoiDung"></bean:define>
											<td><html:link
													action="/confirm/registerUser?id=${MaNguoiDung}">
		...
		$(document).ready(function(){
			...
			for(var i=1;i<=pagniationNum;i++){
				if(currentPageIndex==i){
					$("#pagniationUL").append('<li class="active"><a href="${pageContext.request.contextPath}/admin/listPenddingUser.do?page='+i+'">'+i+'</a></li>');
				}else{ 
					$("#pagniationUL").append('<li><a href="${pageContext.request.contextPath}/admin/listPenddingUser.do?page='+i+'">'+i+'</a></li>');
				}
			}
		});
